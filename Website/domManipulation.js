...
document.querySelector('#url-input').addEventListener('click', ()=>{
  toggleDropdown(true)
}) 

document.querySelectorAll('#urls-to-report p').forEach((el) => {
  el.addEventListener('click', (e)=>{
    document.querySelector('#url-input').value = e.target.innerText
    document.querySelector('#url-input').click()
  })
})