...
function Spinner(){
	...
	Spinner.element.setAttribute('display','inline');
	...
	document.querySelector('#loading-spinner div').appendChild(Spinner.element)
	document.querySelector('#loading-spinner div').style="display: flex; flex-direction: column;align-items: center;"
}
Spinner.id=null;
